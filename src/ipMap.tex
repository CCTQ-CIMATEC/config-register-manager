...
\hline
\textbf{Register} & \textbf{Offset} & \textbf{Field} & \textbf{Bits} & \textbf{Access\_Policy} & \textbf{Volatile} & \textbf{reset} & \textbf{Description} & \textbf{Enum Values} \\ \hline
\multirow{4}{*}{CTRL2} & \multirow{4}{*}{0x0000} & MODE2     & [1:0]  & RW  & false & 'h1  & Operation mode      & 0:Idle; 1:Run; 2:Sleep \\ \cline{3-9}
...
CFG     & 0x0004 & CLOCKDIV  & [7:0]  & RW  & false & 'h2  & Clock divider       &                         \\ \hline
\multirow{2}{*}{STAT2} & \multirow{2}{*}{0x0008} & ERR       & [0]    & RO  & true  & 'h0  & Error flag          &                         \\ \cline{3-9}
        &        & READY     & [1]    & RO  & true  & 'h1  & Ready status        &                         \\ \hline
\multirow{2}{*}{DATA2} & \multirow{2}{*}{0x0010} & IN      & [15:0] & WO  & false & 'h0  & Input data          &                         \\ \cline{3-9}
